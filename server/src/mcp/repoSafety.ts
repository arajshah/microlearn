...
export type ToolErrorCode =
  ...
  | 'STEWARD_CHARTER_MISSING'
  | 'CURRICULUM_STRATEGY_MISSING'
  | 'VERSION_CONFLICT'
  | 'STEWARD_RUN_NOT_FOUND'
  | 'STEWARD_RUN_IN_PROGRESS'
  | 'STEWARD_RUN_ALREADY_FINISHED'
  | 'INVALID_STRATEGY_VERSION'
  | 'SOURCE_NOT_READY'
  | 'INVALID_TIMEZONE'
  | 'INVALID_SCHEDULE'
  | 'EXCEPTIONAL_CONFIRMATION_REQUIRED'
  | 'AUTOMATION_IDENTITY_REQUIRED'
  | 'AUTOMATION_GRANT_EXISTS'
  | 'AUTOMATION_GRANT_NOT_FOUND'
  | 'AUTOMATION_GRANT_REQUIRED'
  | 'AUTOMATION_REVOKED'
  ...
  | 'AUTOMATION_ROADMAP_REQUIRED'
  | 'AUTOMATION_ROADMAP_DENIED'
  | 'AUTOMATION_ROADMAP_DELETE_DENIED'
  | 'AUTOMATION_BADGE_DEFINITION_DENIED'
  | 'AUTOMATION_CROSS_ROADMAP'
